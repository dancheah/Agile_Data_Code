...
REGISTER /opt/personal/pkg/elasticsearch-0.90.5/lib/*.jar
...
STORE sent_count_json INTO 'es://inbox/sentcounts?json=true&size=1000' USING com.infochimps.elasticsearch.pig.ElasticSearchStorage(
  '/opt/personal/pkg/elasticsearch-0.90.5/config/elasticsearch.yml', 
  '/opt/personal/pkg/elasticsearch-0.90.5/plugins');
